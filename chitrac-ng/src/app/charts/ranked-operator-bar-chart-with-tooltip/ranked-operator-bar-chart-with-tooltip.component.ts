...
@Component({
  selector: 'app-ranked-operator-bar-chart-with-tooltip',
  standalone: true,
  imports: [CommonModule, BarChartWithTooltipComponent],
  templateUrl: './ranked-operator-bar-chart-with-tooltip.component.html',
  styleUrls: ['./ranked-operator-bar-chart-with-tooltip.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RankedOperatorBarChartWithTooltipComponent implements OnInit, OnDestroy, OnChanges {
