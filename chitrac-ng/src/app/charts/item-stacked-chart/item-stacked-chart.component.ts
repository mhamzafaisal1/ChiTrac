...
@Component({
  selector: 'app-item-stacked-chart',
  standalone: true,
    ...
    <div class="chart-container" [class.dark-mode]="isDarkTheme">
      <div class="loading-overlay" *ngIf="isLoading">
        <div class="loading-content">
          ...
          <div class="loading-text">Loading item data...</div>
        </div>
      </div>
...
export class ItemStackedChartComponent implements OnInit, OnDestroy, DataAwareComponent {
