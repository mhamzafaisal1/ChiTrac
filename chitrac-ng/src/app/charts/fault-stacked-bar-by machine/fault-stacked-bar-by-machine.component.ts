    ...
    <div class="chart-container" [class.dark-mode]="isDarkTheme">
      <div class="loading-overlay" *ngIf="isLoading">
        <div class="loading-content">
          ...
          <div class="loading-text">Loading fault data...</div>
        </div>
      </div>
...
export class FaultStackedBarByMachineComponent implements OnInit, OnDestroy, DataAwareComponent {
  @Input() chartConfig: CartesianChartConfig | null = null;
  @Input() chartWidth = 600;
  @Input() chartHeight = 400;
  @Input() marginTop = 30;
  @Input() marginRight = 15;
